...
<script>
    $('#dataTable').DataTable({
        ...
        "columns": [
            ...
            {"data":"sellUserName","width": "10%","title":"卖家","orderable": false},
                ...
                "render": function (data, type, row) {
                    if(row.stateCode == 2){
                        return [
                            ...
                            '</a>',
                            '<a class="btn btn-primary btn-xs table-action btn-block confirm" href="javascript:void(0)">',
