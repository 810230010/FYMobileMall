...
<script>
    $('#dataTable').DataTable({
        ...
        "columns": [
            ...
            {"data":"sellPrice","width": "10%","title":"出价","orderable": true},
            {
                "data":"image",
                "width": "10%",
                "title":"结构式",
            ...
            {"data":"state","width": "10%","title":"状态","orderable": false},
            {
                "data":"sellId",
                "width": "10%",
                "title":"操作",
                ...
                "render": function (data, type, row) {
                    if(row.stateCode == 2){
                        return [
                            ...
                            '</a>',
                            '<a class="btn btn-primary btn-xs table-action btn-block close" href="javascript:void(0)">',
                            '关闭 <i class="fa fa-eye"></i>',
                            '</a>'
                        ].join('');
                    }else{
                        return [
    ...
    table.on( 'click', '.detail', function () {
        ...
        window.location.href = "/sell/page/publish/detail?itemId=" + data.sellId;
    });
